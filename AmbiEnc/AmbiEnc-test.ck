...
PulseOsc osc(Math.mtof(60)) => AmbiEnc3 amb() => dac;
SawOsc osc2(Math.mtof(63)) => AmbiEnc3 amb2(64, AmbiEnc3.RADIANS) => dac;
SawOsc osc3(Math.mtof(70)) => AmbiEnc3 amb3(64, AmbiEnc3.RADIANS) => dac;
